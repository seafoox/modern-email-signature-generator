...
const CompactTemplate: React.FC<TemplateProps> = ({ data, t, theme }) => {
  ...
  return (
    <div className="signature-container">
      <table cellPadding="0" cellSpacing="0" style={{
        ...
        <tbody>
          <tr>
            <td valign="top" style={{ paddingRight: '20px', width: '100px' }}>
              {fullName && (
                <img
                  src={safePictureUrl}
                  alt={fullName}
                  width="100"
                  height="100"
                  style={{ display: 'block', borderRadius: '50%', width: '100px', objectFit: 'cover' }}
                />
              )}
            </td>
            <td valign="top">
              <table cellPadding="0" cellSpacing="0" style={{ borderCollapse: 'collapse', width: '100%' }}>
                <tbody>
                  {fullName && (
                    <tr><td style={{ paddingBottom: '2px', fontFamily: fontStack, fontSize: '18px', fontWeight: 'bold', color: data.primaryColor, lineHeight: '1.2' }}>{fullName}</td></tr>
                  )}
                  {roleAndCompany && (
                    <tr><td style={{ paddingBottom: '8px', fontFamily: fontStack, color: currentTheme.secondaryText, lineHeight: '1.4' }}>{roleAndCompany}</td></tr>
                  )}
                  
                  <tr><td style={{ borderTop: `1px solid ${currentTheme.divider}`, paddingTop: '8px' }}>
                    <table cellPadding="0" cellSpacing="0" style={{ borderCollapse: 'collapse', width: '100%' }}>
                        <tbody>
